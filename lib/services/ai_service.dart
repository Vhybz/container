...
class AiService {
  ...
  String _buildSystemPrompt() {
    ...
    if (role == UserRole.pharmacist) {
      ...
      roleSpecificInstructions = "SOP: Scan barcodes to verify stock, manage debts via customer profiles, and process sales carefully.";
    } else if (role == UserRole.admin || role == UserRole.superAdmin) {
      roleSpecificInstructions = "SOP: Monitor net profit, verify financial transfers, manage multi-industry modules, and staff permissions.";
    }
