...
import 'screens/pharmacy/pharmacist_pos.dart';
import 'screens/barbershop/barbershop_dashboard.dart';
import 'screens/barbershop/barber_pos.dart';
import 'screens/tech_shop/tech_shop_dashboard.dart';
import 'screens/tech_shop/tech_pos.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/barbershop/pos': (context) => const BarberPos(),
        '/tech': (context) => const TechShopDashboard(),
        '/tech/pos': (context) => const TechPos(),
      },
    );
  }
}
