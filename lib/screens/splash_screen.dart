                    ...
                    FadeTransition(
                      ...
                      child: const Column(
                        children: [
                          ...
                          Text(
                            'PHARMACY • BARBERSHOP • TECH • RETAIL',
                            style: TextStyle(
                    ...
                    FadeTransition(
                      ...
                      child: Row(
                        ...
                        children: const [
                          ...
                          SizedBox(width: 20),
                          Icon(Icons.content_cut_outlined, color: Colors.white, size: 30),
                          SizedBox(width: 20),
                          Icon(Icons.phone_android_outlined, color: Colors.white, size: 30),
                          SizedBox(width: 20),
                          Icon(Icons.point_of_sale_outlined, color: Colors.white, size: 30),
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Loading Business Modules... ${(_progressAnimation.value * 100).toInt()}%',
                            style: TextStyle(
